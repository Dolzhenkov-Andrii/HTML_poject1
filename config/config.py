...
IMG_URL = f'http://{APP_HOST}/static/'
...
ACTIVE_POST_STATUS = get_value('ACTIVE_POST_STATUS')
BLOCKED_POST_STATUS = get_value('BLOCKED_POST_STATUS')
PASSWORD_SALT = get_value('PASSWORD_SALT')
UPLOAD_FOLDER = get_value('UPLOAD_FOLDER')
ALLOWED_EXTENSIONS = get_value('ALLOWED_EXTENSIONS')
...
VALID_MIN_SIZE_POST_TITLE = get_value('VALID_MIN_SIZE_POST_TITLE', 6)
VALID_MAX_SIZE_POST_TITLE = get_value('VALID_MAX_SIZE_POST_TITLE', 30)
VALID_MIN_SIZE_POST_TEXT = get_value('VALID_MIN_SIZE_POST_TEXT', 1)
VALID_MAX_SIZE_POST_TEXT = get_value('VALID_MAX_SIZE_POST_TEXT', 250)
